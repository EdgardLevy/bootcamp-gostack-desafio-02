...
Segundo desafio da formação gostack 9
...
Dar início ao desenvolvimento de um app gerenciador de academia, o **Gympoint**.

Nesse desafio vamos criar algumas funcionalidades básicas que aprendemos ao longo das aulas até aqui. Esse projeto será desenvolvido aos poucos até o fim da sua jornada onde você terá uma aplicação completa envolvendo back-end, front-end e mobile, que será utilizada para a **certificação do bootcamp**.
